      ...
      <MainContent>
              ...
              <Box>
                ...
                <Group mt="sm" gap="md" c="gray.4">
                  ...
                  {project.categories[0] && (
                    <Flex align="center" gap={6}>
                      <Calendar size={14} />
                      <Badge variant="outline" color="blue.5" style={{ textTransform: "none" }}>
        ...
        <Grid>
          <GridCol span={{ base: 12, lg: 8 }}>
            <MotionDiv variants={staggerContainerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
                ...
                <MotionDiv variants={fadeUpVariants}>
                  <Box>
                    ...
                    {project.galeries.length > 0 ? (
                      <MotionDiv variants={staggerContainerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }}>
                        <Grid>
                  ...
                  <Card bg="dark.5" withBorder>
                    ...
                    <Flex wrap="wrap" gap="xs">
                      {project.technologies.map((technology) => (
                        <Badge key={technology.id} variant="outline" color="blue.5" style={{ textTransform: "none" }}>
                          {technology.name}
                        </Badge>
                      ))}
                    </Flex>
